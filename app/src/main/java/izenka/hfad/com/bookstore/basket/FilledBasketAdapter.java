...
public class FilledBasketAdapter extends RecyclerView.Adapter<FilledBasketAdapter.BookViewHolder> {
    ...
    FilledBasketAdapter(LifecycleOwner owner, BasketViewModel viewModel, List<BookInBasketModel> bookInBasketModelList) {
        this.owner = owner;
