...
public class FilledBasketFragment extends Fragment implements ButtonsClickListener, RecyclerItemTouchHelperListener {
...
//    }
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        viewModel.getBookListLiveData().observe(this, bookInBasketModelList -> {
            rvBookList.setAdapter(new FilledBasketAdapter(this, viewModel, bookInBasketModelList));
        });
        btnChooseEth.setOnClickListener(btn -> {
            ((FilledBasketAdapter) rvBookList.getAdapter()).checkAll();
        });
    ...
    public void onSwiped(RecyclerView.ViewHolder viewHolder, int direction, int position) {
        if (viewHolder instanceof FilledBasketAdapter.BookViewHolder) {
...
//            final int deletedIndex = viewHolder.getAdapterPosition();
            ...
            ((FilledBasketAdapter) rvBookList.getAdapter()).removeItem(viewHolder);
...
//                    ((FilledBasketAdapter)rvBookList.getAdapter()).restoreItem(deletedItem, deletedIndex);
//                }
//            });
