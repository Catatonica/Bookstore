...
public class BookFragment extends Fragment {
    ...
    @BindView((R.id.tvPrise))TextView tvPrise;
    @BindView((R.id.tvAuthor))TextView tvAuthor;
    @BindView((R.id.tvPublisher))TextView tvPublisher;
    @BindView((R.id.tvDescription))TextView tvDescription;
    @BindView((R.id.putInBasket))mehdi.sakout.fancybuttons.FancyButton btnPutInBasket;
    @BindView((R.id.ivBookImage))ImageView ivBookImage;
    @BindView((R.id.ibExpand))ImageButton ibExpand;
    @BindView((R.id.btnNotify))FancyButton btnNotify;
    @BindView((R.id.tvCount))TextView tvCount;
    @BindView((R.id.tvPages))TextView tvPages;
    @BindView((R.id.tvCover))TextView tvCover;
    ...
    private void setBookInfo(Book book) {
        ...
        if (book.getCount() != 0) {
            //TODO: notify user that book is available
    ...
    private void setAuthors(List<Author> authorList){
